                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="middlename" class="form-control" id="firstname"
                                    aria-describedby="firstname" placeholder="Enter First Name">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="age" class="form-control" id="firstname"
                                    aria-describedby="firstname" placeholder="Enter First Name">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select type="button" class="form-control pt-0 rounded-1 pb-0" name="yearlevel" id="gender">
                                    @for ($i = 1; $i < 13; $i++)
